...
<body>
<div class="wrap" style="background-image: url(images/g4.jpg); background-position: center; background-size: cover; height: 100vh;">
  <div class="container">
  <div class="row" style="padding-left: 250px; padding-top: 100px;">
    <div class="col-8 shadow lg mb-5 rounded" style="background:  rgba(76, 175, 80, 0.2);">
    <br><h3 style="text-align: center;">Edit Data Klien</h3><br>
