...
if(isset($_POST['submit'])){
    ...
    // query update data
    $query = "UPDATE team SET nama = '$nama', email = '$email', layanan = '$layanan', deskripsi = '$deskripsi' WHERE id_proyek = $id";
...
$query = "SELECT * FROM team WHERE id_proyek = $id";
...
<body>
<div style="background-image: url(images/about.jpg); background-position: center; background-size: cover; height: 100vh;">
  <div class="container">
  <div class="row" style="padding-left: 250px; padding-top: 100px;">
    <div class="col-8 shadow lg mb-5 rounded" style="background:  rgba(76, 175, 80, 0.3);">
    <br><h3 style="text-align: center;">Kirim Status Project ke Admin</h3><br>
    <?php while($row = mysqli_fetch_assoc($data)){ ?>
    <form action="proses_kirimstatus.php" method="POST">
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-default">ID_Klien:</span>
          </div>
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="id_pesan" value="<?php echo $row['id_proyek']; ?>">
        </div>
        <div class="input-group mb-3">
          <div class="input-group-prepend">
        ...
        <input type="submit" class="btn btn-primary" name="submit-3" value="Proyek Selesai">
        <a href="dashboard-team.php"><input type="button" class="btn btn-light" value="Kembali" style="float: right;"></a>
        <br><br>
    </form>
    <?php
    } // end while
