<?php
  ...
  $query  = mysqli_query($koneksi, "SELECT * FROM pemesanan ORDER BY pemesanan.id_pesan ASC");
?>
...
<div id="main" >
  ...
  <p style="padding-top: 10px; float: right; padding-right: 15px;">Admin</p>
  <img src="images/Me.png" alt="Avatar" 
  style="width:60px; margin: 0; float: right; padding-right: 20px;">
</div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;">
          ...
          <a href="edit.php?id=<?php echo $row['id_pesan']; ?>"><button type="submit" style="border-radius: 10px; background-color: #198c19; padding: 5px 10px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
      </td>
    </tr>
    <?php $x++; ?>
    <?php } ?>
